...
async fn main() {
    ...
    draw_texture_ex(
        ...
        draw_text(
            &format!(
                " x {}, y {}\nt-x {}, t-y {}",
                (game_data.player.x * 10.0).floor() / 10.0,
                (game_data.player.y * 10.0).floor() / 10.0,
                game_data.player.target_x,
                game_data.player.target_y
            ),
            em * 17.0,
            2.0 * em,
            em * 0.8,
        ...
        draw_text(
            &format!(
                " round: {}, move :{}",
                game_data.round, game_data.player.sub_round
            ),
            em * 17.0,
            3.0 * em,
            em * 0.8,
